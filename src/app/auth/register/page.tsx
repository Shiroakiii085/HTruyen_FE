      ...
      <div className="relative z-10 max-w-md w-full p-10 md:p-12 bg-paper-warm/90 rounded-[2rem] shadow-premium border-2 border-gold-dim/20 backdrop-blur-xl overflow-hidden">
        ...
        {isLoading && (
          <div className="absolute inset-0 z-50 bg-paper-aged/90 backdrop-blur-md flex flex-col items-center justify-center animate-in fade-in duration-300">
            ...
            <p className="text-blood-sect font-black tracking-[0.2em] uppercase text-sm animate-pulse text-center px-6 font-[family-name:var(--font-heading)]">
              Đang ngưng tụ căn bản...<br/>
              <span className="text-mist-gray mt-2 block text-[10px] tracking-widest">Đang khắc hoạ ngọc giản<br/>Xin đợi trong chốc lát!</span>
            </p>
          </div>
        )}
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          <div className="space-y-2">
            <label className="block text-[10px] font-black text-mist-gray uppercase tracking-[0.3em] ml-2">Đạo Hiệu</label>
            <input 
              type="text" 
              required
              value={username}
          ...
          <div className="space-y-2">
            <label className="block text-[10px] font-black text-mist-gray uppercase tracking-[0.3em] ml-2">Chân Ngôn (Mật khẩu)</label>
            <input 
              type="password" 
              required
              value={password}
          ...
          >
            {isLoading ? 'ĐANG TỤ KHÍ...' : 'ĐĂNG KÝ DANH TỰ'}
          </button>
        </form>
